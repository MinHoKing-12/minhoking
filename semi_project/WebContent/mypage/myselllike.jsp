				...
				<div class="row gtr-200">
					...
					<div class="col-8  col-12-narrower imp-narrower">
						<div id="content">
							<div>
								<ul class="tabs">
									<li id="myfreelike">자유게시판</li>
									<li id="myselllike" class="current">거래게시판</li>
								</ul>
							</div>
							...
							<div>
								...
								if(list == null || list.size() == 0){  //글이 하나도 없을때
								   %>
								   <tr>
								      <td colspan="8" align="center">관심있는 글이 없습니다</td>
								   </tr>
								   <%
								}else{
								...
								<tr>
									...
									for(int i = 1; i <= totalPages; i++) {
										if(str != null && !str.equals("")) {
											%>
											<a class="paging" href="mypagecontrol?command=myselllike&page=<%=i %>&search-select=<%=select %>&search-text=<%=str %>"><%=i %></a>
											<%
										}else {
											%>
											<a class="paging" href="mypagecontrol?command=myselllike&page=<%=i %>"><%=i %></a>
											<%
										}
									}
									%>
								...
								<div class="search-div">
									<form id="search-form" action="mypagecontrol">
										<input type="hidden" name="command" value="myselllike">
