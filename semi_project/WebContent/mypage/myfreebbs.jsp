				...
				<div class="row gtr-200">
					...
					<div class="col-8  col-12-narrower imp-narrower">
						<div id="content">
							<div>
								<ul class="tabs">
									<li id="myfreebbs" class="current">자유게시판</li>
									<li id="mysellbbs">거래게시판</li>
								</ul>
							</div>
							...
							<div>
								...
								<tr>
									...
									for(int i = 1; i <= totalPages; i++) {
										if(str != null && !str.equals("")) {
											%>
											<a class="paging" href="mypagecontrol?command=myfreebbs&page=<%=i %>&search-select=<%=select %>&search-text=<%=str %>"><%=i %></a>
											<%
										}else {
											%>
											<a class="paging" href="mypagecontrol?command=myfreebbs&page=<%=i %>"><%=i %></a>
											<%
										}
									}
									%>
								...
								<div class="search-div">
									<form id="search-form" action="mypagecontrol">
										<input type="hidden" name="command" value="myfreebbs">
