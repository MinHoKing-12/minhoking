					...
					<div class="table" align="center">
						...
						<div class="pagging" align="center">
							...
							for(int i = 1; i <= totalPages; i++) {
								...
								%>
								<a href="admincontrol?command=msgbox&type=send&page=<%=i %>&search-select=<%=select %>&search-text=<%=text %>"><%=i %></a>
								<%	
								}else {
								%>
								<a href="admincontrol?command=msgbox&type=send&page=<%=i %>"><%=i %></a>
								<%
								}
							}
							%>
